...
ActiveRecord::Schema.define(version: 2021_01_27_095128) do
  ...
  create_table "piyocomics", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.text "introduction"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_piyocomics_on_user_id"
  end
  ...
  add_foreign_key "piyocomics", "users"
end
